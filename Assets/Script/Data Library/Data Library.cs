...
public class DataLibrary
{
    ...
    //KEY FORMAT 
    // name(from so or whatever) + type needed, between them put a underscore, unless using enums them nvm I guess
    //eg. MoveInDirection_velocity
    private Dictionary<string, bool> boolValuePairs = new Dictionary<string, bool>();
    private Dictionary<string, float> floatValuePairs = new Dictionary<string, float>();
    private Dictionary<string, Vector3> vector3ValuePairs = new Dictionary<string, Vector3>();
    ...
    public bool CheckIfKeyExists(string key, DATATYPE dataType)
    {
        bool result = false;
        switch (dataType)
        {
